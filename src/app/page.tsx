  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-fleetzen-teal via-fleetzen-blue to-fleetzen-teal-dark flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full text-center">
        ...
        <p className="text-gray-600 mb-8">Suivi des interventions</p>
        ...
        <div className="space-y-4">
          ...
          <Link
            href="/interventions"
            className="flex items-center justify-center gap-2 w-full bg-gray-100 text-gray-700 py-3 rounded-lg font-medium hover:bg-gray-200 transition"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
